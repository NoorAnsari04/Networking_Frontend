class ApiConstants {
  static const String baseUrl = 'http://192.168.18.104:3000';
  ...
  static const String socialSignup = '/api/auth/socialLogin';
  ...
  static const String loadInterests = '/api/interest/all';
  static const String fetchInterestName = '/api/interest/name';
  static const String connectSpeakers = '/api/connect/conference/connect';
  static const String getRequestStatus = '/api/connect/status';
  static const String contactSupport = '/api/support/';
  static const String termsAndConditions = '/api/terms/';
  static const String conferenceAgenda = '/api/conference/:conferenceId/agenda';
